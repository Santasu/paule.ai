...
module.exports = async (req, res) => {
  try {
    ...
    const songs = take([
      ...
      { title: 'Rugsėjo dangus',   cover: '/assets/hero/music.webp', link: '/biblioteka#dainos' },
    ]);
    ...
    const photos = take([
      ...
      { title: 'Peizažas',   url: '/assets/hero/photo.webp',  link: '/biblioteka#nuotraukos' },
    ]);
    ...
    const videos = take([
      ...
      { title: 'Teaser 6s',     thumb: '/assets/hero/video.webp', link: '/biblioteka#video' },
    ]);
    ...
    res.status(500).json({ ok:false, error:'INTERNAL', detail: String(e?.message || e) });
  }
};
